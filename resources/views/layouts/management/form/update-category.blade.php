    ...
    <x-slot:title>
        ...
        <div id="main" class="pt-xl-0 pt-sm-3 mt-0 ml-1 px-4">
            <div class="row">
                <div class="col-6">
                    <div class="m-0 pt-2 ">
                        <h3 class="m-0 p-0 text-white">Ubah Kategori</h3>
                        <p class="text-white-50">Form perubahan kategori</p>
                    </div>
                </div>
                ...
                <div class="col-6 mt-3">
                    <nav class="breadcrumb-header float-md-end" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="add-item">Ubah Kategori</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="px-2 d-flex justify-content-end">
                                    <button class="btn btn-primary w-auto" type="submit">Ubah Kategori</button>
                                </div>
                            </div>
                        </div>
                    </div>
